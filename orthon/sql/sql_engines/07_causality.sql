...
cross_prediction AS (
    SELECT
        ...
        CORR(a.y, b.y_lag10) AS cross_prediction
    FROM lagged_base a
    JOIN lagged_base b ON a.I = b.I AND a.signal_id != b.signal_id
    WHERE b.y_lag10 IS NOT NULL
...
FROM binned_with_change a
JOIN binned_with_change b ON a.I = b.I + 5 AND a.signal_id != b.signal_id  -- Source leads by 5
GROUP BY a.signal_id, b.signal_id;
