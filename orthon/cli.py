...
Usage:
    python -m orthon.interpret --data data/
    python -m orthon.interpret --data data/ --entity engine_1
    python -m orthon.interpret --data data/ --alerts
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='ORTHON - Interpret PRISM parquet outputs'
    )
    parser.add_argument(
        '--data', '-d',
        type=str,
